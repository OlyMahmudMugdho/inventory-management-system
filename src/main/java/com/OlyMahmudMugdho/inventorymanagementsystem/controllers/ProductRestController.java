...
//    @GetMapping("/search")
//    public ResponseEntity<String> searchProduct(@RequestParam(defaultValue = " ") String keyword, Model model) {
//        List<Product> products = productRepository.search(keyword);
//        System.out.println(products);
//        return new ResponseEntity<>(products.getFirst().toString(), HttpStatus.OK);
//    }
